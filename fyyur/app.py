...
def venues():
  ...
  #   })
  #   for venue in venues2:
  #     new_venue = []
  #     new_venue.append({
  #       'id': venue.id,
  #       'name': venue.name,
  #       'num_upcoming_show': len(list(filter(lambda x: x.start_time > datetime.now(), venue.shows))) 
  #     })

  #   response['venues'] = new_venue
...
def show_artist(artist_id):
  ...
  for show in artist.shows:
    artist_detail = {
      ...
      "venue_image_link": show.venues.website_link,
      "start_time": show.start_time.isoformat()
    }
